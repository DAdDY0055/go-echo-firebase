...
type Product struct {
	...
	Col  null.String `boil:"col" json:"col,omitempty" toml:"col" yaml:"col,omitempty"`
...
var ProductWhere = struct {
	...
	Col  whereHelpernull_String
}{
	ID:   whereHelperint{field: "`product`.`id`"},
	Name: whereHelpernull_String{field: "`product`.`name`"},
	Col:  whereHelpernull_String{field: "`product`.`col`"},
}
...
var (
	productAllColumns            = []string{"id", "name", "col"}
	productColumnsWithoutDefault = []string{"id", "name", "col"}
